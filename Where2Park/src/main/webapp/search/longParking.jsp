							...
							$.ajax({
								...
								success: function (result) {
									...
									obj.forEach(element => {
										...
										+ "<tr><td>제목: " + element.parking_title + "</td></tr>"
										+ "<tr><td>위치: " + element.parking_location + "</td></tr>"	
										+ "<tr><td>유형: " + element.parking_type + "</td></tr>"
										+ "<tr><td>시간: " + element.parking_intime + "</td></tr>"
										+ "<tr><td>가격: " + element.parking_price + "</td></tr>";
										list.append(txt);
					...
					<c:forEach var="parking" items="${LP_List}">
						...
						<a href="searchParkingDetail.do?parking_id=${parking.parking_id}">
							<table class="parking-lot" border="1">
								<tr>
									<td><img id='pkpic'src='images/${parking.parking_pic}'/></td>
								</tr>
							
								<tr>
									<td>제목: ${parking.parking_title}</td>
								</tr>
								<tr>
									<td>위치: ${parking.parking_location}</td>
								</tr>
									<tr>
									<td>유형: ${parking.parking_type}</td>
								</tr>
								<tr>
									<td>시간: ${parking.parking_intime}
									</td>
								</tr>
								<tr>
									<td>가격: ${parking.parking_price}</td>
								</tr>
								<!-- 찜 기능 작업중에 있습니다 -->
								<tr>
									
										<td>
											<form action="insert_wish.do" method="post">
												<%-- <input type="checkbox" name="parking_id" value="${wishList.parking_id}" id="chckheart"/> --%>
												<input type ="text" name="parking_id" value="${wishList.parking_id}"/>
